  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
    <div class="mx-auto max-w-2xl lg:max-w-4xl lg:px-12 mt-8 lg:mt-12">
      <div class="mt-6 space-y-2 font-display text-2xl tracking-tight text-blue-900">
        <div style={{columnCount: 2, columnGap: '1rem', color: '#272343'}}>
          <p>
          ...
          <p style={{color:'#272343'}}>
            ...
            interactive graphs and visually appealing layouts, we make the process not only informative but also engaging and fun.
          </p>
          <br></br>
          <p style={{color:'#272343'}}>
