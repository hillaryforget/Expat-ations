...
export default function Map({city_One, city_Two}) {
  const cityOne = {
    lng: CoordCalc(Object.values(city_One.bounding_box.latlon)[0], Object.values(city_One.bounding_box.latlon)[3]),
    lat: CoordCalc(Object.values(city_One.bounding_box.latlon)[1], Object.values(city_One.bounding_box.latlon)[2]),
  };
  const cityTwo = {
    lng: CoordCalc(Object.values(city_Two.bounding_box.latlon)[0], Object.values(city_Two.bounding_box.latlon)[3]),
    lat: CoordCalc(Object.values(city_Two.bounding_box.latlon)[1], Object.values(city_Two.bounding_box.latlon)[2]),
  };
